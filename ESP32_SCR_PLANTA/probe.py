                ...
                if(self.pin_voltaje.value()):           # si esta en ciclo negativo, voltaje valor alto en la señal.
                    ...
                    if(not self.pin_voltaje.value()):   # Validar si ya cambio al ciclo postitivo.
                        ...
                        if(self.pin_voltaje.value()):           # valirdar si esta en ciclo negativo
                            sleep_us(100)
                            self.SCR[self.scr_act].value(0)     # desactivar SCR ACTIVO.
                            #sleep_us(20)                        
                            
                            """ Current Polling """
                            while(self.pin_current.value()):    # activacion SCR 120.
                                pass                            # Polling señal currnt hasta cruzar por cero en elevacion.
                            
                            sleep_us(100)                       # delay cruze por cero para activar SCR.
                            
                            if(not self.pin_current.value()):   # Validar si esta en ciclo positivo. señal baja.
                                
                                self.SCR["120"].value(1)        # Activar SCR 120V
                                self.scr_act = "120"
                    ...
                    if(self.pin_voltaje.value()):               # Validar si ya cambio al ciclo negativo
                        ...
                        if(not self.pin_current.value()):   # valirdar si esta en ciclo postivo
                            self.SCR["120"].value(1)
                            self.scr_act = "120"
                            self.mod1.value(1)  # 120
                            self.mod2.value(0)
                            self.cont_btn = 2  # next 150V
            
            sleep(120) # tiempo duracion 120V
                ...
                if(self.pin_voltaje.value()):           # si esta en ciclo negativo, voltaje valor alto en la señal.
                    ...
                    if(not self.pin_voltaje.value()):   # Validar si ya cambio al ciclo postitivo.
                        ...
                        if(self.pin_voltaje.value()):           # valirdar si esta en ciclo negativo
                            ...
                            """ Current Polling """
                            while(self.pin_current.value()):    # activacion SCR 150.
                                pass                            # Polling señal currnt hasta cruzar por cero en elevacion.
                            ...
                            if(not self.pin_current.value()):   # Validar si esta en ciclo positivo. señal baja.
                                ...
                                self.SCR["150"].value(1)        # Activar SCR 150V
                                self.scr_act = "150"
                                self.mod1.value(0)  
                    ...
                    if(self.pin_voltaje.value()):               # Validar si ya cambio al ciclo negativo
                        ...
                        if(not self.pin_current.value()):   # valirdar si esta en ciclo postivo
                            self.SCR["150"].value(1)
                            self.scr_act = "150"
                            self.mod1.value(0)  
                            self.mod2.value(1)  # 150V
                            self.cont_btn = 1  # next 150V
                            
            sleep(120) # tiempo duration 150V
